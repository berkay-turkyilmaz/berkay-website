export function buildAyetInterpretSystemPrompt(): string {
...
5. **Not** — Belirsizlik veya farklı okumalar varsa kısa uyarı
...
export function buildAyetUserMessage(input: {
  reference?: string;
  verseText?: string;
  question?: string;
}): string {
